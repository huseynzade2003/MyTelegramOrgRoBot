...
Qeyd: Nömrənizi önündə ölkə kodunu yazmağı unutmayın (Məsələn: +994501112233)
...
Məlumatlarınızı yenidən daxil etmək istəyisinizsə /start verin"""
    ...
    ERRED_PAGE = "Xəta baş verdi. Hesab məlumatlarınızı əldə etmək alınmadı. \n\n@Mr_HD_20"
    CANCELLED_MESG = "Əlvida! /start verərək botu yenidən başladın"
